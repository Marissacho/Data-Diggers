...
def store_recommendation(purchased_item_lst, dataframe):
    with dpg.window(label="Items and Store Recommendations",width= 1100,height=800):
        ...
        for i in range(5):
            ...
            dpg.add_text(f"Category: {category}\n\n")
...
dpg.create_viewport(title="Store Front Design - Recommender", width= 1100,height=800)
dpg.setup_dearpygui()
dpg.show_viewport()
dpg.start_dearpygui()
